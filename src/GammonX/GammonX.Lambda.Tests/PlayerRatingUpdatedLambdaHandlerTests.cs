...
{
    public  class PlayerRatingUpdatedLambdaHandlerTests
    {
        [Fact]
        public async Task OnPlayerRatingUpdatedEventTest()
        {
            ...
            var handler = LambdaFunctionFactory.Create(services, LambdaFunctions.PlayerRatingUpdatedFunc);
